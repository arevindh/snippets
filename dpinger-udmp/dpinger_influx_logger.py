...
cmd.extend(["-r", "10s","-d","1", "-D", "500m","-t", "60s","-I",source, target])

# Set up formats
url = '{0}/write?db={1}'.format(influx_url, influx_db)
datafmt = "dpinger,host={0},name={1},target={2} latency={{0:.3f}},stddev={{1:.3f}},loss={{2}}".format(host, name, target)
